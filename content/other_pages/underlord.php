    ...
    <div class="all-hero-inf">
        <div class="hero-continer">
            <div class="hero-vido_container">
                ...
                <video class="_22nJ5nsfHDS2jEscPEne0-" poster="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/abyssal_underlord.png" autoplay="" preload="auto" loop="" playsinline=""><source type="video/mp4; codecs=&quot;hvc1&quot;" src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/abyssal_underlord.mov"><source type="video/webm" src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/abyssal_underlord.webm?undefined">
                <img src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/abyssal_underlord.png"></video>
                </div>
            </div>
            <div class="text-hero-container">
                ...
                <div class="h1-tekst">Underlord</div>
                <div class="deskription-hero-text">Телепортирует свою команду в битву или помогает ей сбежать</div>
                <div class="b-deskription-hero-text-container">
                    <div class="hero-story">
                        <div class="h-s-text f-b">Underlord обрушивает волны рокового пламени на врагов, обездвиженных своей злобной хваткой.<span class="f-b">Он ослабляет атаки противников одним своим видом, упивается праздником смерти,</span>  
                        <span class="f-b">получая прилив сил с каждым недругом, павшим в его присутствии, и разрывает полотно реальности,</span> перемещаясь с союзниками по полю брани. Жестокая кара ждёт каждого, кто восстанет против Врогроша, Владыки бездны.
                    </div>
                    <div>
