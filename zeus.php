    ...
    <div class="all-hero-inf">
        <div class="hero-continer">
            ...
            <div class="text-hero-container">
                ...
                <div class="h1-tekst">Zeus</div>
                <div class="deskription-hero-text">Бьёт молниями врагов как вблизи, так и вдали</div>
                <div class="b-deskription-hero-text-container">
                    <div class="hero-story">
                        <div class="h-s-text f-b">  <span class="f-b">Никому не спастись от ярости Zeus.</span> Он использует молнию, чтобы разведывать ближайшие территории, 
                        <span class="f-b"> пускает заряд электричества, скачущий по нескольким врагам, </span> или призывает вселяющий ужас шквал молний на всех противников сразу. Zeus найдет врагов, где бы те ни были.
                    </div>
                    <div>
