    ...
    <div class="all-hero-inf">
        <div class="hero-continer">
            <div class="hero-vido_container">
                ...
                <video class="_22nJ5nsfHDS2jEscPEne0-" poster="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/phantom_lancer.png" autoplay="" preload="auto" loop="" playsinline=""><source type="video/mp4; codecs=&quot;hvc1&quot;" src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/phantom_lancer.mov"><source type="video/webm" src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/phantom_lancer.webm?undefined">
                <img src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/phantom_lancer.png"></video>
                </div>
            </div>
            <div class="text-hero-container">
                ...
                <div class="h1-tekst">Phantom Lancer</div>
                <div class="deskription-hero-text">Создаёт иллюзии, которые помогают обхитрить или сразить врага</div>
                <div class="b-deskription-hero-text-container">
                    <div class="hero-story">
                        <div class="h-s-text f-b">Phantom Lancer уничтожает противников бесконечным запасом своих клонов.<span class="f-b">Его армия иллюзий сметает вражеские силы и укрепления шквалом молниеносных ударов, </span> а заодно запутывает противника,  
                        <span class="f-b"> позволяя избежать опасности.</span>
                    </div>
                    <div>
