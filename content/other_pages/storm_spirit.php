    ...
    <div class="all-hero-inf">
        <div class="hero-continer">
            ...
            <div class="text-hero-container">
                ...
                <div class="h1-tekst">Storm Spirit</div>
                <div class="deskription-hero-text">Проносится молнией по карте в поисках битвы</div>
                <div class="b-deskription-hero-text-container">
                    <div class="hero-story">
                        <div class="h-s-text f-b">  <span class="f-b">Storm Spirit не пропускает ни одного сражения.</span> Он молнией проносится по карте, со всех сторон бьёт врагов 
                        <span class="f-b"> своими взрывными копиями и заряженными атаками и исчезает с поля битвы, </span> прежде чем шокированные противники успеют среагировать.
                    </div>
                    <div>
