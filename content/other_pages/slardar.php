    ...
    <div class="all-hero-inf">
        <div class="hero-continer">
            <div class="hero-vido_container">
                ...
                <video class="_22nJ5nsfHDS2jEscPEne0-" poster="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/slardar.png" autoplay="" preload="auto" loop="" playsinline=""><source type="video/mp4; codecs=&quot;hvc1&quot;" src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/slardar.mov"><source type="video/webm" src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/slardar.webm?undefined">
                <img src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/slardar.png"></video>
                </div>
            </div>
            <div class="text-hero-container">
                ...
                <div class="h1-tekst">Slardar</div>
                <div class="deskription-hero-text">Преследует, ослабляет и оглушает врагов</div>
                <div class="b-deskription-hero-text-container">
                    <div class="hero-story">
                        <div class="h-s-text f-b">Всегда готовый найти и сокрушить врагов Slardar шустро вползает в битву.<span class="f-b">Раскрыв расположение противника и разрушив его броню,</span>  
                        <span class="f-b">он сокращает расстояние до жертвы и держит её на месте сокрушительными водными всплесками и оглушающими ударами своего внушительного трезубца.</span>
                    </div>
                    <div>
