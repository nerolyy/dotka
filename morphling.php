    ...
    <div class="all-hero-inf">
        <div class="hero-continer">
            ...
            <div class="text-hero-container">
                ...
                <div class="h1-tekst">Morphling</div>
                <div class="deskription-hero-text">Обходит врагов, превращаясь в волну</div>
                <div class="b-deskription-hero-text-container">
                    <div class="hero-story">
                        <div class="h-s-text f-b">  <span class="f-b">Благодаря способности вливаться в любую</span> ситуацию Morphling увёртлив и смертоносен.
                        <span class="f-b">Если его пытаются загнать в угол, он уходит от врага на своей волне</span> или увеличивает здоровье и перемещается к созданному им ложному двойнику героя.
                    <div>
