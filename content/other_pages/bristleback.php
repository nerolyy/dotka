    ...
    <div class="all-hero-inf">
        <div class="hero-continer">
            <div class="hero-vido_container">
                ...
                <video class="_22nJ5nsfHDS2jEscPEne0-" poster="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/bristleback.png" autoplay="" preload="auto" loop="" playsinline=""><source type="video/mp4; codecs=&quot;hvc1&quot;" src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/bristleback.mov"><source type="video/webm" src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/bristleback.webm?undefined">
                <img src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/bristleback.png"></video>
                </div>
            </div>
            <div class="text-hero-container">
                ...
                <div class="h1-tekst">Bristleback</div>
                <div class="deskription-hero-text">Получает меньше урона, отвернувшись от врагов</div>
                <div class="b-deskription-hero-text-container">
                    <div class="hero-story">
                        <div class="h-s-text f-b">В сражении Bristleback совсем не против подставить врагам спину. <span class="f-b">Уменьшая весь урон, который ему наносят сзади и сбоку, </span>  
                        <span class="f-b">он безрассудно бросается в бой и обдаёт врагов смертоносными иглами и замедляющими соплями.</span>
                    </div>
                    <div>
