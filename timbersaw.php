    ...
    <div class="all-hero-inf">
        <div class="hero-continer">
            ...
            <div class="text-hero-container">
                ...
                <div class="h1-tekst">Timbersaw</div>
                <div class="deskription-hero-text">Прорубается сквозь лес в поисках противников</div>
                <div class="b-deskription-hero-text-container">
                    <div class="hero-story">
                        <div class="h-s-text f-b">Увёртливый и непредсказуемый Timbersaw рубит лес так,<span class="f-b">что валятся его враги.</span>  
                        <span class="f-b">Он метает огромные пилы и может притянуться к дереву цепью, сокрушая неприятелей по пути.</span>
                    </div>
                    <div>
