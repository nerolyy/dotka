    ...
    <div class="all-hero-inf">
        <div class="hero-continer">
            ...
            <div class="text-hero-container">
                ...
                <div class="h1-tekst">Anti-Mage</div>
                <div class="deskription-hero-text">Выжигает ману врагов атаками</div>
                <div class="b-deskription-hero-text-container">
                    <div class="hero-story">
                        <div class="h-s-text f-b">Если Anti-Mage наберёт полную силу, мало кто сможет его остановить. Он способен <span class="f-b">забирать у врагов ману</span> каждым ударом или 
