    ...
    <div class="all-hero-inf">
        <div class="hero-continer">
            <div class="hero-vido_container">
                <div class="video bh">
                    <video class="_22nJ5nsfHDS2jEscPEne0-" poster="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/bounty_hunter.mov" autoplay preload="auto" loop playsinline>
                        <source type="video/mp4; codecs=&quot;hvc1&quot;" src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/bounty_hunter.mov">
                        <source type="video/webm" src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/bounty_hunter.webm?undefined"><img src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/bounty_hunter.png">
                    </video>
                </div>
            </div>
            <div class="text-hero-container">
                ...
                <div class="h1-tekst">BOUNTY HUNTER</div>
                <div class="deskription-hero-text">Крадёт у врагов золото и получает дополнительную награду за их убийство</div>
                <div class="b-deskription-hero-text-container">
                    <div class="hero-story">
                        <div class="h-s-text f-b">Bounty Hunter<span class="f-b">незримо крадётся</span>  по следам своих врагов и не даёт им скрыться из виду. Когда его жертва падает замертво, он и его союзники получают 
                        <span class="f-b">хорошую прибыль</span>
                    </div>
                    <div>
