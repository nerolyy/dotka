        ...
        <div class="hero-continer">
            <div class="hero-vido_container">
                <div class="antimage video">
                    <video class="_22nJ5nsfHDS2jEscPEne0-" poster="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/juggernaut.mov" autoplay preload="auto" loop playsinline>
                        <source type="video/mp4; codecs=&quot;hvc1&quot;" src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/juggernaut.mov">
                        <source type="video/webm" src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/juggernaut.webm?undefined"><img src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/juggernaut.png">
                    </video>
                </div>
            </div>
            <div class="text-hero-container">
                ...
                <div class="h1-tekst">Juggernaut</div>
                <div class="deskription-hero-text">Разрубает врагов точными взмахами меча</div>
                <div class="b-deskription-hero-text-container">
                    <div class="hero-story">
                        <div class="h-s-text f-b">Juggernaut разрубает своих врагов  <span class="f-b">шквалом рассекающих ударов.</span> Мало кто сможет  
                        <span class="f-b">остановить или пережить его отчаянное наступление, ведь,</span>набрав обороты, он становится практически неуязвимым.
                    </div>
                    <div>
