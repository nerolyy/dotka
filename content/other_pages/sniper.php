...
background-color: #212121;">
    <div class="all-hero-inf">
        <div class="hero-continer">
            ...
            <video class="_22nJ5nsfHDS2jEscPEne0-" poster="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/sniper.png" autoplay="" preload="auto" loop="" playsinline=""><source type="video/mp4; codecs=&quot;hvc1&quot;" src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/sniper.mov"><source type="video/webm" src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/sniper.webm?undefined">
            <img src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/sniper.png"></video>
            </div>
            </div>
            <div class="text-hero-container">
                ...
                <div class="h1-tekst">Sniper</div>
                <div class="deskription-hero-text">Обстреливает врагов издалека</div>
                <div class="b-deskription-hero-text-container">
                    <div class="hero-story">
                        <div class="h-s-text f-b">Сеять смерть на расстоянии — вот что Sniper умеет лучше всего <span class="f-b">Он сдерживает своих врагов нескончаемым градом пуль,</span> 
                        <span class="f-b"> а в подходящий момент добивает их смертельным выстрелом.</span>
                    </div>
                    <div>
