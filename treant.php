    ...
    <div class="all-hero-inf">
        <div class="hero-continer">
            ...
            <div class="text-hero-container">
                ...
                <div class="h1-tekst">Treant Protector</div>
                <div class="deskription-hero-text">Опутывает врагов корнями, воззвав к силам леса</div>
                <div class="b-deskription-hero-text-container">
                    <div class="hero-story">
                        <div class="h-s-text f-b">Великодушный Treant Protector защищает своих соратников и союзные постройки восстанавливающей бронёй.<span class="f-b">Незаметно перемещаясь меж деревьев, </span>  
                        <span class="f-b">он связывает врагов корнями и передаёт их жизненные силы товарищам.</span>
                    </div>
                    <div>
