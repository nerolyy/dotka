    ...
    <div class="all-hero-inf">
        <div class="hero-continer">
            <div class="hero-vido_container">
                <div class="antimage video">
                    <video class="_22nJ5nsfHDS2jEscPEne0-" poster="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/arc_warden.mov" autoplay preload="auto" loop playsinline>
                        <source type="video/mp4; codecs=&quot;hvc1&quot;" src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/arc_warden.mov">
                        <source type="video/webm" src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/arc_warden.webm?undefined"><img src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/arc_warden.png">
                    </video>
                </div>
            </div>
            <div class="text-hero-container">
                ...
                <div class="h1-tekst">ARC WARDEN</div>
                <div class="deskription-hero-text">Копирует себя, чтобы вести войну на два фронта</div>
                <div class="b-deskription-hero-text-container">
                    <div class="hero-story">
                        <div class="h-s-text f-b">  <span class="f-b">забирать у врагов ману</span> каждым ударом или 
                        <span class="f-b">телепортироваться на небольшие расстояния</span>, что не позволяет врагам загнать его в угол.
                    </div>
                    <div>
