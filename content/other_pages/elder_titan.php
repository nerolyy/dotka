    ...
    <div class="all-hero-inf">
        <div class="hero-continer">
            <div class="hero-vido_container">
                ...
                <video class="_22nJ5nsfHDS2jEscPEne0-" poster="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/elder_titan.png" autoplay="" preload="auto" loop="" playsinline=""><source type="video/mp4; codecs=&quot;hvc1&quot;" src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/elder_titan.mov"><source type="video/webm" src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/elder_titan.webm?undefined">
                <img src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/elder_titan.png"></video>
                </div>
            </div>
            <div class="text-hero-container">
                ...
                <div class="h1-tekst">Elder Titan</div>
                <div class="deskription-hero-text">Наносит врагам урон и выводит их из строя своим астральным духом</div>
                <div class="b-deskription-hero-text-container">
                    <div class="hero-story">
                        <div class="h-s-text f-b">Разведав территорию своим астральным духом, Elder Titan готов атаковать с любого направления.<span class="f-b">Он останавливает противников ударом копыта,</span>  
                        <span class="f-b">разъедает их защиту одним лишь своим присутствием и повергает неприятелей, расколов почву под ними.</span>
                    </div>
                    <div>
