    ...
    <div class="all-hero-inf">
        <div class="hero-continer">
            <div class="hero-vido_container">
                ...
                <video class="_22nJ5nsfHDS2jEscPEne0-" poster="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/primal_beast.png" autoplay="" preload="auto" loop="" playsinline=""><source type="video/mp4; codecs=&quot;hvc1&quot;" src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/primal_beast.mov"><source type="video/webm" src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/primal_beast.webm?undefined">
                <img src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/primal_beast.png"></video>
                </div>
            </div>
            <div class="text-hero-container">
                ...
                <div class="h1-tekst">Primal Beast</div>
                <div class="deskription-hero-text">Расталкивает всех вокруг и разбивает врагов в кровавое месиво</div>
                <div class="b-deskription-hero-text-container">
                    <div class="hero-story">
                        <div class="h-s-text f-b">Primal Beast свирепо расталкивает врагов и союзников,<span class="f-b">чтобы вклиниться в битву и устроить переполох.</span>  
                        <span class="f-b">Этот зверь являет неминуемую угрозу для любого противника, наказывая своих обидчиков и</span> упиваясь возможностью схватить добычу и вбить её в землю, пока от неё не останется лишь кровавое месиво.
                    </div>
                    <div>
