    ...
    <div class="all-hero-inf">
        <div class="hero-continer">
            <div class="hero-vido_container">
                ...
                <video class="_22nJ5nsfHDS2jEscPEne0-" poster="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/life_stealer.png" autoplay="" preload="auto" loop="" playsinline=""><source type="video/mp4; codecs=&quot;hvc1&quot;" src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/life_stealer.mov"><source type="video/webm" src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/life_stealer.webm?undefined">
                    <img src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/life_stealer.png"></video>
                </div>
            </div>
            <div class="text-hero-container">
                ...
                <div class="h1-tekst">Lifestealer</div>
                <div class="deskription-hero-text">Забирается в других существ, делая их быстрее и крепче</div>
                <div class="b-deskription-hero-text-container">
                    <div class="hero-story">
                        <div class="h-s-text f-b">Если Lifestealer смог подобраться близко к своей жертве, то её уже ничего не спасёт.<span class="f-b">Он может забраться внутрь крипа или союзника, чтобы,</span>  
                        <span class="f-b">оказавшись возле врага, неожиданно вырваться из носителя и разорвать жертву своими когтями.</span>
                    </div>
                    <div>
