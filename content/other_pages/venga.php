    ...
    <div class="all-hero-inf">
        <div class="hero-continer">
            ...
            <div class="text-hero-container">
                ...
                <div class="h1-tekst">Vengeful Spirit</div>
                <div class="deskription-hero-text">Может поменяться местами с любым героем неподалёку</div>
                <div class="b-deskription-hero-text-container">
                    <div class="hero-story">
                        <div class="h-s-text f-b">  <span class="f-b">Vengeful Spirit напоминает о себе даже после смерти.</span> Она постоянно сеет хаос в рядах врагов,
                        <span class="f-b">обмениваясь местами с другими героями неподалёку,</span> оглушая врагов и ослабляя того, кто её одолеет.
                    <div>
