    ...
    <div class="all-hero-inf">
        <div class="hero-continer">
            ...
            <div class="text-hero-container">
                ...
                <div class="h1-tekst">Clinkz</div>
                <div class="deskription-hero-text">Нападает на одиноких врагов из невидимости</div>
                <div class="b-deskription-hero-text-container">
                    <div class="hero-story">
                        <div class="h-s-text f-b">  <span class="f-b">Clinkz незримо рыщет по полю битвы</span> и от внезапного нападения не спастись никому.
                        <span class="f-b">Этот изворотливый лучник накрывает врагов дождём огненных стрел,</span>а затем призывает в бой армию пылающих собратьев.
                    </div>
                    <div>
