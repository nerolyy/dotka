    ...
    <div class="all-hero-inf">
        <div class="hero-continer">
            <div class="hero-vido_container">
                ...
                <img src="https://cdn.akamai.steamstatic.com/apps/dota2/videos/dota_react/heroes/renders/ogre_magi.png"></video>
                </div>
            </div>
            <div class="text-hero-container">
                ...
                <div class="h1-tekst">Ogre Mage</div>
                <div class="deskription-hero-text">Усиливает свои заклинания щепоткой удачи</div>
                <div class="b-deskription-hero-text-container">
                    <div class="hero-story">
                        <div class="h-s-text f-b">Благодаря возможности многократно приумножить эффект<span class="f-b">каждого своего заклинания и толике удачи Ogre Magi способен</span>  
                        <span class="f-b">обратить врагов в пепел или усилить союзников.</span> Но, разумеется, полагаться лишь на удачу — дело неблагодарное...
                    </div>
                    <div>
