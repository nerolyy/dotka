...
const heroes = [
    ...
    { name: "Shadow Shaman", attribute: "intelligence", complexity: "low", image: "img/shadow_shaman.svg", href: "index.php?page=content/other_pages/axe" },
    { name: "Silencer", attribute: "intelligence", complexity: "medium", image: "img/molchun.svg ", href: "index.php?page=content/other_pages/axe" },
    { name: "Skywrath Mage", attribute: "intelligence", complexity: "medium", image: "img/petuh.svg", href: "index.php?page=content/other_pages/axe" },
    ...
    { name: "Techies", attribute: "intelligence", complexity: "high", image: "img/Teches.svg", href: "index.php?page=content/other_pages/axe" },
    { name: "Tinker", attribute: "intelligence", complexity: "medium", image: "img/tinker.svg", href: "index.php?page=content/other_pages/axe" },
    ...
    { name: "Weaver", attribute: "agility", complexity: "medium", image: "img/visage.svg", href: "index.php?page=content/other_pages/axe" },
    { name: "Visage", attribute: "intelligence", complexity: "high", image: "images/visage.png", href: "index.php?page=content/other_pages/axe" },
    { name: "Void Spirit", attribute: "intelligence", complexity: "medium", image: "img/void_spirit.svg", href: "index.php?page=content/other_pages/axe" },
    { name: "Warlock", attribute: "intelligence", complexity: "medium", image: "img/warlock.svg", href: "index.php?page=content/other_pages/axe" },
    { name: "Windranger", attribute: "intelligence", complexity: "medium", image: "img/wr.svg", href: "index.php?page=content/other_pages/axe" },
    { name: "Winter Wyvern", attribute: "intelligence", complexity: "medium", image: "img/winter wiwerna.svg", href: "index.php?page=content/other_pages/axe" },
    { name: "Witch Doctor", attribute: "intelligence", complexity: "medium", image: "img/wd.svg", href: "index.php?page=content/other_pages/axe" },
    { name: "Zeus", attribute: "intelligence", complexity: "medium", image: "img/zeus.svg", href: "index.php?page=content/other_pages/axe" },
